...
djd43.provide("djd43.gfx.color.hsv");
djd43.require("djd43.lang.array");
djd43.require("djd43.math");
djd43.lang.extend(djd43.gfx.color.Color, {toHsv:function () {
	return djd43.gfx.color.rgb2hsv(this.toRgb());
}});
djd43.gfx.color.rgb2hsv = function (r, g, b, options) {
	...
	h = djd43.math.round(h);
	s = djd43.math.round(s);
	v = djd43.math.round(v);
	return [h, s, v];
};
djd43.gfx.color.hsv2rgb = function (h, s, v, options) {
	...
	switch (opt.outputRange) {
	  case 1:
		r = djd43.math.round(r, 2);
		g = djd43.math.round(g, 2);
		b = djd43.math.round(b, 2);
		break;
	  case 100:
		r = Math.round(r * 100);
		g = Math.round(g * 100);
