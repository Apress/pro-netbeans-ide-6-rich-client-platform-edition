...
djd43.provide("djd43.undo.Manager");
djd43.require("djd43.lang.common");
djd43.undo.Manager = function (parent) {
	this.clear();
	this._parent = parent;
};
djd43.extend(djd43.undo.Manager, {_parent:null, _undoStack:null, _redoStack:null, _currentManager:null, canUndo:false, canRedo:false, isUndoing:false, isRedoing:false, onUndo:function (manager, item) {
	...
	if (top instanceof djd43.undo.Manager) {
		top.undoAll();
	} else {
		top.undo();
	}
	...
	if (this._currentManager == this) {
		var mgr = new djd43.undo.Manager(this);
	...
	if (this._currentManager == this) {
		if (this._parent) {
			...
			if (this._undoStack.length == 0 || flatten) {
				var idx = djd43.lang.find(this._parent._undoStack, this);
				if (idx >= 0) {
