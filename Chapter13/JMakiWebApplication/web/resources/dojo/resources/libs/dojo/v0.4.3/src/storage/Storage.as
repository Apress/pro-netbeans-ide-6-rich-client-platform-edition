...
class Storage {
	...
	public function Storage(){
		//getURL("javascript:dojo_dot_4_3.debug('FLASH:Storage constructor')");
	...
	public function put(keyName, keyValue, namespace){
		...
		so.onStatus = function(infoObject:Object){
			//getURL("javascript:dojo_dot_4_3.debug('FLASH: onStatus, infoObject="+infoObject.code+"')");
			...
			//getURL("javascript:dojo_dot_4_3.debug('FLASH: onStatus, statusResults="+statusResults+"')");
			
			// give the status results to JavaScript
			DojoExternalInterface.call("dojo_dot_4_3.storage._onStatus", null, statusResults, 
																 keyName);
		}
	...
	static function main(mc){
		//getURL("javascript:dojo_dot_4_3.debug('FLASH: storage loaded')");
