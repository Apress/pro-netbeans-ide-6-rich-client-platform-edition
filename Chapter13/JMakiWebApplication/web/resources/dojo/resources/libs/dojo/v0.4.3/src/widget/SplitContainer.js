...
djd43.provide("djd43.widget.SplitContainer");
...
djd43.widget.defineWidget("djd43.widget.SplitContainer", djd43.widget.HtmlWidget, function () {
	this.sizers = [];
}, {isContainer:true, templateCssString:".dojoSplitContainer{\n\tposition: relative;\n\toverflow: hidden;\n\tdisplay: block;\n}\n\n.dojoSplitPane{\n\tposition: absolute;\n}\n\n.dojoSplitContainerSizerH,\n.dojoSplitContainerSizerV {\n\tfont-size: 1px;\n\tcursor: move;\n\tcursor: w-resize;\n\tbackground-color: ThreeDFace;\n\tborder: 1px solid;\n\tborder-color: ThreeDHighlight ThreeDShadow ThreeDShadow ThreeDHighlight;\n\tmargin: 0;\n}\n\n.dojoSplitContainerSizerV {\n\tcursor: n-resize;\n}\n\n.dojoSplitContainerVirtualSizerH,\n.dojoSplitContainerVirtualSizerV {\n\tfont-size: 1px;\n\tcursor: move;\n\tcursor: w-resize;\n\tbackground-color: ThreeDShadow;\n\t-moz-opacity: 0.5;\n\topacity: 0.5;\n\tfilter: Alpha(Opacity=50);\n\tmargin: 0;\n}\n\n.dojoSplitContainerVirtualSizerV {\n\tcursor: n-resize;\n}\n", templateCssPath:djd43.uri.moduleUri("djd43.widget", "templates/SplitContainer.css"), activeSizing:false, sizerWidth:15, orientation:"horizontal", persist:true, postMixInProperties:function () {
	djd43.widget.SplitContainer.superclass.postMixInProperties.apply(this, arguments);
	this.isHorizontal = (this.orientation == "horizontal");
}, fillInTemplate:function () {
	djd43.widget.SplitContainer.superclass.fillInTemplate.apply(this, arguments);
	djd43.html.addClass(this.domNode, "dojoSplitContainer");
	...
	djd43.widget.SplitContainer.superclass.postCreate.apply(this, arguments);
	for (var i = 0; i < this.children.length; i++) {
		with (this.children[i].domNode.style) {
			position = "absolute";
		}
		djd43.html.addClass(this.children[i].domNode, "dojoSplitPane");
	...
	djd43.html.disableSelection(this.virtualSizer);
	if (this.persist) {
		this._restoreState();
	}
	this.resizeSoon();
	...
	djd43.html.addClass(child.domNode, "dojoSplitPane");
}, _addSizer:function () {
	...
	djd43.event.connect(this.sizers[i], "onmousedown", handler);
	this.domNode.appendChild(this.sizers[i]);
	djd43.html.disableSelection(this.sizers[i]);
	...
	djd43.widget.SplitContainer.superclass.removeChild.call(this, widget, arguments);
	this.onResized();
}, addChild:function (widget) {
	djd43.widget.SplitContainer.superclass.addChild.apply(this, arguments);
	...
	if (this.isHorizontal) {
		...
		slider.style.top = 0;
		djd43.html.setMarginBox(slider, {width:size, height:this.paneHeight});
	} else {
		slider.style.left = 0;
		slider.style.top = pos + "px";
		djd43.html.setMarginBox(slider, {width:this.paneWidth, height:size});
	}
	...
	this.originPos = djd43.html.getAbsolutePosition(this.children[0].domNode, true, djd43.html.boxSizing.MARGIN_BOX);
	if (this.isHorizontal) {
	...
	djd43.event.connect(document.documentElement, "onmousemove", this, "changeSizing");
	djd43.event.connect(document.documentElement, "onmouseup", this, "endSizing");
	...
	this._updateSize();
	this.isSizing = false;
	djd43.event.disconnect(document.documentElement, "onmousemove", this, "changeSizing");
	djd43.event.disconnect(document.documentElement, "onmouseup", this, "endSizing");
	if (this.persist) {
	...
	this._moveSizingLine();
	if (this.isHorizontal) {
		djd43.html.setMarginBox(this.virtualSizer, {width:this.sizerWidth, height:this.paneHeight});
	} else {
		djd43.html.setMarginBox(this.virtualSizer, {width:this.paneWidth, height:this.sizerWidth});
	}
	...
	for (var i = 0; i < this.children.length; i++) {
		...
		var cookieValue = djd43.io.cookie.getCookie(cookieName);
		if (cookieValue != null) {
	...
	for (var i = 0; i < this.children.length; i++) {
		var cookieName = this._getCookieName(i);
		djd43.io.cookie.setCookie(cookieName, this.children[i].sizeShare, null, null, null, null);
	}
}});
djd43.lang.extend(djd43.widget.Widget, {sizeMin:10, sizeShare:10});
djd43.widget.defineWidget("djd43.widget.SplitContainerPanel", djd43.widget.ContentPane, {});
