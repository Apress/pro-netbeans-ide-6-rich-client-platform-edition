...
djd43.provide("djd43.lang.timing.Streamer");
djd43.require("djd43.lang.timing.Timer");
djd43.lang.timing.Streamer = function (input, output, interval, minimum, initialData) {
	var self = this;
	var queue = [];
	...
	var timer = new djd43.lang.timing.Timer(this.interval);
	var tick = function () {
		self.onTick(self);
	...
	this.start = function () {
		...
		djd43.raise("You cannot start a Streamer without an input and an output function.");
	};
