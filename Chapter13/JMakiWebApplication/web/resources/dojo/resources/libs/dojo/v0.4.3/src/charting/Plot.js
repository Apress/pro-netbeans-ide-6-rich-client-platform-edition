...
djd43.provide("djd43.charting.Plot");
djd43.require("djd43.lang.common");
djd43.require("djd43.charting.Axis");
djd43.require("djd43.charting.Series");
djd43.charting.RenderPlotSeries = {Singly:"single", Grouped:"grouped"};
djd43.charting.Plot = function (xaxis, yaxis, series) {
	var id = "dojo-charting-plot-" + djd43.charting.Plot.count++;
	this.getId = function () {
		return id;
	};
	...
	this.series = [];
	this.dataNode = null;
	this.renderType = djd43.charting.RenderPlotSeries.Singly;
	if (xaxis) {
...
djd43.charting.Plot.count = 0;
djd43.extend(djd43.charting.Plot, {addSeries:function (series, plotter) {
	if (series.plotter) {
		this.series.push(series);
	} else {
		this.series.push({data:series, plotter:plotter || djd43.charting.Plotters["Default"]});
	}
