...
djd43.provide("djd43.collections.Graph");
djd43.require("djd43.collections.Collections");
djd43.experimental("djd43.collections.Graph");
djd43.collections.Graph = function (nodes) {
	...
	function nodeList() {
		var d = new djd43.collections.Dictionary();
	...
	function adjacencyList() {
		...
		this.getIterator = function () {
			return new djd43.collections.Iterator([].concat(d));
		};
	}
