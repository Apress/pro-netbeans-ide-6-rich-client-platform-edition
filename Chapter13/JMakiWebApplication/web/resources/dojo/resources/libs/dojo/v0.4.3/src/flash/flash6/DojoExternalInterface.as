...
class DojoExternalInterface{
	...
	public static function initialize(){ 
		//getURL("javascript:dojo_dot_4_3.debug('FLASH:DojoExternalInterface initialize')");
		...
		//getURL("javascript:dojo_dot_4_3.debug('FLASH:dojoPath="+DojoExternalInterface.dojoPath+"')");
	...
	*/
	public static function loaded(){
		//getURL("javascript:dojo_dot_4_3.debug('FLASH:loaded')");
	...
	*/
	...
	public static function _gatewayReady(){
		...
		call("dojo_dot_4_3.flash.loaded");
	}
