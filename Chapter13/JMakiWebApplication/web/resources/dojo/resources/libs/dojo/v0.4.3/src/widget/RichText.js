...
djd43.widget.defineWidget("djd43.widget.RichText", djd43.widget.HtmlWidget, function () {
	...
	if (djConfig["useXDomain"] && !djConfig["dojoRichTextFrameUrl"]) {
		djd43.debug("djd43.widget.RichText: When using cross-domain Dojo builds," + " please save src/widget/templates/richtextframe.html to your domain and set djConfig.dojoRichTextFrameUrl" + " to the path on your domain to richtextframe.html");
	}
	this.iframe.src = (djConfig["dojoRichTextFrameUrl"] || djd43.uri.moduleUri("djd43.widget", "templates/richtextframe.html")) + ((djd43.doc().domain != currentDomain) ? ("#" + djd43.doc().domain) : "");
