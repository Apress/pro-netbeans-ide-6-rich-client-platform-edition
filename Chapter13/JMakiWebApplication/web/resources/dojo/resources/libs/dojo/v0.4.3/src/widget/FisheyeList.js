...
djd43.provide("djd43.widget.FisheyeList");
...
djd43.widget.defineWidget("djd43.widget.FisheyeList", djd43.widget.HtmlWidget, function () {
	...
	djd43.event.connect(document.documentElement, "onmouseout", this, "_onBodyOut");
	djd43.event.connect(this, "addChild", this, "_initializePositioning");
	...
	if (djd43.html.overElement(djd43.body(), e)) {
		return;
	}
	this._setDormant(e);
	...
	var x = 0;
	var y = 0;
	var mb = djd43.html.getMarginBox(itm.lblNode);
	...
	var pos = djd43.html.getAbsolutePosition(this.domNode, true);
	...
	if (this.timerScale < 1) {
		djd43.lang.setTimeout(this, "_expandSlowly", 10);
	}
}, destroy:function () {
	djd43.event.disconnect(document.documentElement, "onmouseout", this, "_onBodyOut");
	djd43.event.disconnect(document.documentElement, "onmousemove", this, "_onMouseMove");
	djd43.widget.FisheyeList.superclass.destroy.call(this);
}});
djd43.widget.defineWidget("djd43.widget.FisheyeListItem", djd43.widget.HtmlWidget, {iconSrc:"", svgSrc:"", caption:"", id:"", _blankImgPath:djd43.uri.moduleUri("djd43.widget", "templates/images/blank.gif"), templateString:"<div class=\"dojoHtmlFisheyeListItem\">" + "  <img class=\"dojoHtmlFisheyeListItemImage\" dojoAttachPoint=\"imgNode\" dojoAttachEvent=\"onMouseOver;onMouseOut;onClick\">" + "  <div class=\"dojoHtmlFisheyeListItemLabel\" dojoAttachPoint=\"lblNode\"></div>" + "</div>", fillInTemplate:function () {
	if (this.svgSrc != "") {
		this.svgNode = this._createSvgNode(this.svgSrc);
		this.domNode.appendChild(this.svgNode);
		this.imgNode.style.display = "none";
	} else {
		if ((this.iconSrc.toLowerCase().substring(this.iconSrc.length - 4) == ".png") && (djd43.render.html.ie) && (!djd43.render.html.ie70)) {
			if (djd43.dom.hasParent(this.imgNode) && this.id != "") {
	...
	if (this.caption != "") {
		djd43.html.addClass(this.lblNode, "selected");
		this.parent._positionLabel(this);
	}
}, onMouseOut:function (e) {
	djd43.html.removeClass(this.lblNode, "selected");
}, onClick:function (e) {
}});
