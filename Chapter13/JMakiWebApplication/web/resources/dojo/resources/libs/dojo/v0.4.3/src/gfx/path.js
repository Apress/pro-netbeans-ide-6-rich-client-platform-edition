...
djd43.provide("djd43.gfx.path");
djd43.require("djd43.math");
djd43.require("djd43.gfx.shape");
djd43.declare("djd43.gfx.path.Path", djd43.gfx.Shape, {initializer:function (rawNode) {
	this.shape = djd43.lang.shallowCopy(djd43.gfx.defaultPath, true);
	this.segments = [];
	this.absolute = true;
	this.last = {};
	this.attach(rawNode);
	...
	for (var i = 0; i < l; ++i) {
		path.push(djd43.gfx.formatNumber(n[i], true));
	}
	...
	var p = path.match(djd43.gfx.pathRegExp);
	this.segments = [];
	this.absolute = true;
	this.bbox = {};
	this.last = {};
	...
	this.shape = djd43.gfx.makeParameters(this.shape, typeof (newShape) == "string" ? {path:newShape} : newShape);
