...
djd43.provide("djd43.charting.svg.Axis");
djd43.require("djd43.lang.common");
if (djd43.render.svg.capable) {
	djd43.extend(djd43.charting.Axis, {renderLines:function (plotArea, plot, plane) {
		if (this.nodes.lines) {
		...
		var g = this.nodes.lines = document.createElementNS(djd43.svg.xmlns.svg, "g");
		...
		for (var i = 0; i < this._labels.length; i++) {
			...
			var l = document.createElementNS(djd43.svg.xmlns.svg, "line");
		...
		var g = this.nodes.ticks = document.createElementNS(djd43.svg.xmlns.svg, "g");
		...
		var g = this.nodes.labels = document.createElementNS(djd43.svg.xmlns.svg, "g");
		...
		this.nodes.main = document.createElementNS(djd43.svg.xmlns.svg, "g");
		var g = this.nodes.main;
		g.setAttribute("id", this.getId());
		var line = this.nodes.axis = document.createElementNS(djd43.svg.xmlns.svg, "line");
		if (plane == "x") {
