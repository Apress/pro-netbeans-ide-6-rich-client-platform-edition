...
djd43.provide("djd43.lfx.shadow");
djd43.require("djd43.lang.common");
djd43.require("djd43.uri.Uri");
djd43.lfx.shadow = function (node) {
	this.shadowPng = djd43.uri.moduleUri("djd43.html", "images/shadow");
	this.shadowThickness = 8;
	this.shadowOffset = 15;
	this.init(node);
};
djd43.extend(djd43.lfx.shadow, {init:function (node) {
	this.node = node;
	this.pieces = {};
