...
djd43.provide("djd43.date.supplemental");
djd43.date.getFirstDayOfWeek = function (locale) {
...
djd43.date.getWeekend = function (locale) {
...
djd43.date.isWeekend = function (dateObj, locale) {
	var weekend = djd43.date.getWeekend(locale);
