...
class DojoExternalInterface{
	...
	public static function addCallback(methodName:String, instance:Object, 
		...
		ExternalInterface.call("dojo_dot_4_3.flash.comm._addExternalInterfaceCallback", 
													 methodName);
	...
	/** 
			...
			will fire the dojo_dot_4_3.flash.loaded() event, so that JavaScript can know that
			Flash has finished loading and adding its callbacks, and can begin to
			interact with the Flash file.
	*/
	public static function loaded(){
		DojoExternalInterface.call("dojo_dot_4_3.flash.loaded");
	}
	...
	public static function chunkArgumentData(value, argIndex:Number):Void{
		//getURL("javascript:dojo_dot_4_3.debug('FLASH: chunkArgumentData, value="+value+", argIndex="+argIndex+"')");
	...
	public static function exec(methodName):Void{
		...
		//getURL("javascript:dojo_dot_4_3.debug('FLASH: encoded result data="+DojoExternalInterface.resultData+"')");
	}
	...
	public static function chunkReturnData(segment:Number):String{
		...
		//getURL("javascript:dojo_dot_4_3.debug('FLASH: chunking return piece="+piece+"')");
	...
	private static function encodeData(data){
		//getURL("javascript:dojo_dot_4_3.debug('inside flash, data before="+data+"')");
		...
		//getURL("javascript:dojo_dot_4_3.debug('inside flash, data after="+data+"')");
		return data;
	}
