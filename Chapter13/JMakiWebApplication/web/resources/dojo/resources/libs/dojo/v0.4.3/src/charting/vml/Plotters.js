...
djd43.provide("djd43.charting.vml.Plotters");
djd43.require("djd43.lang.common");
if (djd43.render.vml.capable) {
	djd43.mixin(djd43.charting.Plotters, {_group:function (plotarea) {
		...
		var group = djd43.charting.Plotters._group(plotarea);
