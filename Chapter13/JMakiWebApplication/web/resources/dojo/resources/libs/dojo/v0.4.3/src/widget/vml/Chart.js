...
djd43.provide("djd43.widget.vml.Chart");
...
djd43.widget.defineWidget("djd43.widget.vml.Chart", [djd43.widget.HtmlWidget, djd43.widget.Chart], function () {
	...
	var y = djd43.widget.vml.Chart.Plotter.getY(this.properties.axes.x.plotAt, this);
	...
	var line = document.createElement("v:line");
	var x = djd43.widget.vml.Chart.Plotter.getX(this.properties.axes.y.plotAt, this);
	...
	t.innerHTML = djd43.math.round(parseFloat(this.properties.axes.x.range.min), 2);
	...
	t.style.fontFamily = "sans-serif";
	t.style.fontSize = size + "px";
	t.innerHTML = djd43.math.round(parseFloat(this.properties.axes.x.range.max), 2);
	this.vectorNode.appendChild(t);
	t = document.createElement("div");
	t.style.position = "absolute";
	...
	t.style.fontFamily = "sans-serif";
	t.style.fontSize = size + "px";
	t.innerHTML = djd43.math.round(parseFloat(this.properties.axes.y.range.max), 2);
	this.vectorNode.appendChild(t);
	t = document.createElement("div");
	t.style.position = "absolute";
	...
	t.style.fontFamily = "sans-serif";
	t.style.fontSize = size + "px";
	t.innerHTML = djd43.math.round(parseFloat(this.properties.axes.y.range.min), 2);
	this.vectorNode.appendChild(t);
}, init:function () {
	...
	for (var i = 0; i < this.series.length; i++) {
		djd43.widget.vml.Chart.Plotter.plot(this.series[i], this);
	}
}, postCreate:function () {
...
djd43.widget.vml.Chart.Plotter = new function () {
	var self = this;
	var plotters = {};
