...
djd43.provide("djd43.profile");
djd43.profile = {_profiles:{}, _pns:[], start:function (name) {
	...
	if (appendToDoc) {
		...
		if (document.getElementById("profileOutputTable")) {
			djd43.body().replaceChild(ne, document.getElementById("profileOutputTable"));
		} else {
			djd43.body().appendChild(ne);
		}
		ne.appendChild(tbl);
	}
	return tbl;
}};
djd43.profile.stop = djd43.profile.end;
