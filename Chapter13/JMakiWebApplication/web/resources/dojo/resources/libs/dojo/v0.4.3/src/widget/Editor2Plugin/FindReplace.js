...
djd43.provide("djd43.widget.Editor2Plugin.FindReplace");
djd43.require("djd43.widget.Editor2");
djd43.declare("djd43.widget.Editor2Plugin.FindCommand", djd43.widget.Editor2DialogCommand, {SearchOption:{CaseSensitive:4, SearchBackwards:64, WholeWord:2, WrapSearch:128}, find:function (text, option) {
	this._editor.focus();
	if (window.find) {
...
djd43.widget.Editor2Plugin.FindReplace = {getCommand:function (editor, name) {
	...
	var item;
	if (name == "replace") {
		item = new djd43.widget.Editor2ToolbarButton("Replace");
	} else {
		if (name == "find") {
			item = new djd43.widget.Editor2ToolbarButton("Find");
		}
	}
	return item;
}};
djd43.widget.Editor2Manager.registerHandler(djd43.widget.Editor2Plugin.FindReplace.getCommand);
djd43.widget.Editor2ToolbarItemManager.registerHandler(djd43.widget.Editor2Plugin.FindReplace.getToolbarItem);
