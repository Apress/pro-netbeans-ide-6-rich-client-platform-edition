...
djd43.provide("djd43.widget.TreeRpcControllerV3");
djd43.require("djd43.event.*");
djd43.require("djd43.json");
djd43.require("djd43.io.*");
djd43.require("djd43.widget.TreeLoadingControllerV3");
djd43.widget.defineWidget("djd43.widget.TreeRpcControllerV3", djd43.widget.TreeLoadingControllerV3, {extraRpcOnEdit:false, doMove:function (child, newParent, index, sync) {
	...
	deferred.addCallback(function () {
		djd43.widget.TreeBasicControllerV3.prototype.doMove.apply(_this, args);
	});
	return deferred;
	...
	var args = arguments;
	deferred.addCallback(function () {
		djd43.widget.TreeBasicControllerV3.prototype.doDetach.apply(_this, args);
	});
	return deferred;
}, requestEditConfirmation:function (node, action, sync) {
	if (!this.extraRpcOnEdit) {
		return djd43.Deferred.prototype.makeCalled();
	}
	var _this = this;
	var deferred = this.startProcessing(node);
	var params = {node:this.getInfo(node), tree:this.getInfo(node.tree)};
	...
	var args = arguments;
	deferred.addCallback(function () {
		djd43.widget.TreeBasicControllerV3.prototype.doDestroyChild.apply(_this, args);
	});
	return deferred;
	...
	if (djd43.lang.isUndefined(data.title)) {
	...
	deferred.addCallback(function (server_data) {
		...
		return djd43.widget.TreeBasicControllerV3.prototype.doCreateChild.call(_this, parent, index, data);
	});
	return deferred;
	...
	var args = arguments;
	deferred.addCallback(function () {
		djd43.widget.TreeBasicControllerV3.prototype.doClone.apply(_this, args);
	});
	return deferred;
}});
