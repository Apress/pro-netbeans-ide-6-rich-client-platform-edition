...
djd43.provide("djd43.data.CsvStore");
djd43.require("djd43.data.core.RemoteStore");
djd43.require("djd43.lang.assert");
djd43.declare("djd43.data.CsvStore", djd43.data.core.RemoteStore, {_setupQueryRequest:function (result, requestKw) {
	...
	djd43.lang.assertType(arrayOfArrays, Array);
	var arrayOfItems = [];
	...
	djd43.lang.assertType(arrayOfObjects, Array);
	var output = {};
	...
	djd43.unimplemented("djd43.data.CsvStore.newItem");
}, deleteItem:function (item) {
	djd43.unimplemented("djd43.data.CsvStore.deleteItem");
}, setValues:function (item, attribute, values) {
	djd43.unimplemented("djd43.data.CsvStore.setValues");
}, set:function (item, attribute, value) {
	djd43.unimplemented("djd43.data.CsvStore.set");
}, unsetAttribute:function (item, attribute) {
	djd43.unimplemented("djd43.data.CsvStore.unsetAttribute");
}, save:function (keywordArgs) {
	djd43.unimplemented("djd43.data.CsvStore.save");
}, revert:function () {
	djd43.unimplemented("djd43.data.CsvStore.revert");
}, isDirty:function (item) {
	djd43.unimplemented("djd43.data.CsvStore.isDirty");
}});
