...
djd43.provide("djd43.charting.Axis");
djd43.require("djd43.lang.common");
djd43.charting.Axis = function (label, scale, labels) {
	var id = "dojo-charting-axis-" + djd43.charting.Axis.count++;
	this.getId = function () {
		return id;
	};
...
djd43.charting.Axis.count = 0;
djd43.extend(djd43.charting.Axis, {getCoord:function (val, plotArea, plot) {
...
djd43.requireIf(djd43.render.svg.capable, "djd43.charting.svg.Axis");
djd43.requireIf(djd43.render.vml.capable, "djd43.charting.vml.Axis");
