 ...
 */
public class BeansBindingSampleView extends FrameView {
    
    public BeansBindingSampleView(SingleFrameApplication app) {
        super(app);
    ...
    public void newRecord() {
        com.pronetbeans.examples.Doughnuts d = new com.pronetbeans.examples.Doughnuts();
    ...
    public void deleteRecord() {
        ...
        List<com.pronetbeans.examples.Doughnuts> toRemove = new ArrayList<com.pronetbeans.examples.Doughnuts>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            com.pronetbeans.examples.Doughnuts d = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(d);
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = BeansBindingSampleApp.getApplication().getMainFrame();
            aboutBox = new BeansBindingSampleAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        BeansBindingSampleApp.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        entityManager = javax.persistence.Persistence.createEntityManagerFactory("ProNetBeansDoughnutsPU").createEntityManager();
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.pronetbeans.examples.BeansBindingSampleApp.class).getContext().getResourceMap(BeansBindingSampleView.class);
        ...
        descriptionTextValidator1 = new com.pronetbeans.examples.DescriptionTextValidator();
        myTextValidator1 = new com.pronetbeans.examples.validators.MyTextValidator();
        ...
        binding.setSourceNullValue("Blah"); // NOI18N
        binding.setSourceUnreadableValue(null);
        binding.setValidator(myTextValidator1);
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.description}"), descriptionField, org.jdesktop.beansbinding.BeanProperty.create("text_ON_ACTION_OR_FOCUS_LOST"), "FooBar");
        binding.setSourceNullValue("");
        binding.setSourceUnreadableValue(null);
        binding.setValidator(descriptionTextValidator1);
        bindingGroup.addBinding(binding);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(com.pronetbeans.examples.BeansBindingSampleApp.class).getContext().getActionMap(BeansBindingSampleView.class, this);
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(mainPanelLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(nameField, javax.swing.GroupLayout.DEFAULT_SIZE, 357, Short.MAX_VALUE)
                            .addComponent(descriptionField, javax.swing.GroupLayout.DEFAULT_SIZE, 357, Short.MAX_VALUE)
                            .addComponent(priceField, javax.swing.GroupLayout.DEFAULT_SIZE, 357, Short.MAX_VALUE)))
                    .addGroup(mainPanelLayout.createSequentialGroup()
                        .addContainerGap()
    ...
    private com.pronetbeans.examples.DescriptionTextValidator descriptionTextValidator1;
    private javax.persistence.EntityManager entityManager;
    private javax.swing.JSeparator jSeparator1;
    private javax.swing.JSeparator jSeparator2;
    private java.util.List<com.pronetbeans.examples.Doughnuts> list;
    private javax.swing.JPanel mainPanel;
    private javax.swing.JScrollPane masterScrollPane;
    private javax.swing.JTable masterTable;
    private javax.swing.JMenuBar menuBar;
    private com.pronetbeans.examples.validators.MyTextValidator myTextValidator1;
